...
```bash
curl -sL https://raw.githubusercontent.com/sassanom/proxmox/main/lxc/nginx-proxy-manager/create.sh | bash -s -- --cores 4
```
...
```bash
wget --no-cache -qO - https://raw.githubusercontent.com/sassanom/proxmox/main/lxc/nginx-proxy-manager/setup.sh | sh
```
